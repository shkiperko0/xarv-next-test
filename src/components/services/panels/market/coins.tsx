...
import { CoinsProvider } from "../../providers/market/coins"
import { select_perpage_options } from "../common"

export function CoinsMenu(props: IServiceMenuProps){
    ...
    async function fetchItemsList(){
        const data = await CoinsProvider.list({ offset: page * perpage, limit: perpage, count: true })
