...
import { IServiceMenuProps, styles } from "@components/services"
import { ItemsProvider } from "@components/services/providers/market/items"
...
export function ItemsMenu(props: IServiceMenuProps){
    ...
    async function fetchItemsList(){
        const data = await ItemsProvider.list({page, perpage})
