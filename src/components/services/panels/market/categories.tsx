...
import { CategoriesProvider } from "@components/services/providers/market/categories"
...
export function CategoriesMenu(props: IServiceMenuProps){
    ...
    async function fetchItemsList(){
        const data = await CategoriesProvider.list({ offset: page * perpage, limit: perpage, count: true })
